    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="flex items-center justify-center gap-2">
          <BiEdit className="text-xl cursor-pointer text-black/40" onClick={() => editFunc(agent?.id || "")} />
          <MdDelete onClick={() => deleteFunc(agent.id || "")} className="text-xl cursor-pointer text-black/40" />
        </div>
