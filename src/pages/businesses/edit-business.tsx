...
const initialBusinessState: Partial<IBusiness> = { user_string: "", name: "", description: "", categories: [], phonenumber: "", email: "", state_id: "", lga: "", town: "", address: "", month_started: "", year_started: "", profile_img: "", cover_img: ""}
...
const EditBusiness = () => {
  ...
  const [filteredLgas, setfilteredLgas] = React.useState<{ id: string; state_id: string; name: string; }[]>([]) 
...
//   console.log("bua", businessCategories)
    ...
    useEffect(() => {
        if(stateId) {
            setBusinessData(prev => ({...prev, "state_id": stateId }))
            if (lgas) {
...
//   console.log("business", businessData)
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault()
        const data = { ...businessData, user_string: user?.verify_string, profile_img: profileImg || businessData?.profile_img, cover_img: coverImg || businessData?.cover_img }
                ...
                <form className='p-8 px-4 bg-white sm:px-8 rounded-2xl' onSubmit={handleSubmit}>
                    ...
                    <div className='justify-between mb-8 md:flex gap-9'>
                        ...
                        <div className='flex flex-col w-full'>
                            ...
                            <input required={true} value={businessData?.year_started} onChange={handleBusinessData} className="p-2 px-3 text-sm border rounded-md outline-none" type="number" name="year_started" id="year_started" placeholder='Enter your business start Year' />
                        </div>
                    </div>
                        ...
                        <div className='mb-32 mt-9 md:flex gap-9'>
                            <div className='mb-4'>
                                <label htmlFor="profile_img" className='font-medium text-sm bg-[#E5E5E5] p-16 py-20 flex flex-col items-center justify-center max-w-[25rem] rounded-2xl relative max-h-96 cursor-pointer'>
                                    ...
                                    {(profileImg || businessData?.profile_img) &&
                                        <img src={profileImg || businessData?.profile_img?.replace("mediatoken", "media&token")} alt="" className='absolute top-0 left-0 z-10 object-cover w-full h-full' />
                                    }        
